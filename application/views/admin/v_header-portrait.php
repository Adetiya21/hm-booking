                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>HEADER PORTRAIT</h4>
                                        <span>Berikut data header portrait.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?= site_url('admin/header-portrait') ?>">Header Portrait</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Daftar Gambar Header Portrait</h5>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <div class="dt-responsive">
                                            ...
                                            <?= form_open('admin/header/proses_portrait',$arb); ?>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/header/jsonPortrait", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("admin/header/hapus_portrait/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function edit(id)
    {
        ...
        $.ajax({
            url : '<?php echo site_url("admin/header/edit_portrait/'+id+'") ?>',
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
    ...
    function save()
    {
        ...
        url = "<?php echo site_url('admin/header/update_portrait')?>";
