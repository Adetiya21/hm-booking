                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>LAPORAN SELESAI <?= strtoupper($bln) ?></h4>
                    ...
                    <div class="page-body">
                        <div class="card">
                            <div class="card-header">
                                <h5>Data Laporan Selesai perBulan <?= $bln ?></h5>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">           
                                                <select class="form-control" onchange="location = this.value;">
                                                    ...
                                                    <option value="<?= site_url('admin/laporan-selesai')?>">Semua</option>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/laporan_selesai/json_bulan/<?= $blnn ?>", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
