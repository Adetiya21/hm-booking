                            ...
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        ...
                                        <span>Berikut data laporan status selesai.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?= site_url('admin/laporan-selesai') ?>">Laporan Selesai</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="page-body">
                        <div class="card">
                            <div class="card-header">
                                <h5>Data Laporan Status Selesai</h5>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">           
                                                <select class="form-control" onchange="location = this.value;">
                                                    ...
                                                    <option value="<?= site_url('admin/laporan-selesai')?>" selected>Semua</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/01')?>">January</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/02')?>">February</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/03')?>">March</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/04')?>">April</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/05')?>">Mey</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/06')?>">June</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/07')?>">July</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/08')?>">August</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/09')?>">September</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/10')?>">October</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/11')?>">November</option>
                                                    <option value="<?= site_url('admin/laporan-selesai/bulan/12')?>">December</option>
                                                </select>
                                            </div>    
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/laporan_selesai/json/", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
