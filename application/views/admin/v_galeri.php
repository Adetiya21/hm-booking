                            ...
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?= site_url('admin/galeri') ?>">Galeri</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <div class="dt-responsive">
                                            ...
                                            <?= form_open('admin/galeri/proses',$arb); ?>
                                            <div class="form-group">
                                              <label class="col-form-label">Gambar Galeri</label><br>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/galeri/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
        ...
        {"data": "gambar","orderable": false,
            render: function(data) { 
                if(data!==null) {
                  return '<img class="img-thumbnail" width="100%" src="<?= base_url('assets/images/galeri/') ?>'+data+'">'
                } else {
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("admin/galeri/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function edit(id)
    {
        ...
        $.ajax({
            url : '<?php echo site_url("admin/galeri/edit/'+id+'") ?>',
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
