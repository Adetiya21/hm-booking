        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="footer__widget">
            <div class="footer__social">
              <a href="<?= $ten->fb ?>"><i class="fa fa-facebook"></i></a>
              <a href="<?= $ten->ig ?>"><i class="fa fa-instagram"></i></a>
              <a href="tel:<?= $ten->no_telp ?>"><i class="fa fa-phone"></i></a>
            </div>
          </div>
        </div>
      </div>
...
<script src="<?= base_url('assets/front-end/') ?>vendor/select2/select2.min.js"></script>
...
<script>eval(mod_pagespeed_oZiSn7Krs9);</script>
